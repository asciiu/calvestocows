<?php
/* The template for displaying portfolio 3 thumbnails columns */
...
if( has_post_thumbnail() ):
    ...
    if( $pt_folio_thumbs_style_option == 'masonry' ){
        $image = premitheme_image( $post->ID, '', premitheme_img_size('folio-masonry-3col'));
    } else {
        $image = premitheme_image( $post->ID, '', premitheme_img_size('folio-3col'));
    }
?>
