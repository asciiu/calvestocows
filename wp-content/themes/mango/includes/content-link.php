...
$linkURL = get_post_meta($post->ID, 'linkformat_url', TRUE);
?>
...
<?php if ( $linkURL ): ?>
    <div class="entry-link">
        <hgroup>
            <h2><a href="<?php echo $linkURL; ?>" target="_blank"><?php _e('Link: ', 'premitheme');?><?php the_title(); ?></a></h2>
            <h3><?php echo $linkURL; ?></h3>
        </hgroup>
    </div>
<?php endif; ?>
