...
class Flickr_Widget extends WP_Widget {
    ...
    function Flickr_Widget() {
        ...
        $this->WP_Widget( 'flickr-widget', $pt_themename.' - '.__('Flickr Photostream', 'premitheme'), $widget_ops, $control_ops );
    }
...
/-------------------------------*/
    function form($instance) {
        $defaults = array( 'title' => 'Flickr', 'id' => '', 'count' => '9', 'display' => 'latest');
